...
import DSA_implementations.data_structures.BinarySearchTree.INodeCreator;
import DSA_implementations.data_structures.BinarySearchTree.Node;
...
public class TreeMap<K extends Comparable<K>, V> implements IMap<K,V> {
    ...
    private final INodeCreator<K> creator = new INodeCreator<K>() {
        /**
         * {@inheritDoc}
         */
        @Override
    ...
    protected static class TreeMapNode<K extends Comparable<K>, V> extends AVLTree.AVLNode<K> {
        ...
        protected TreeMapNode(Node<K> parent, K key, V value) {
            super(parent, key);
            this.value = value;
        }
