...
import DSA_implementations.data_structures.SkipList.Node;
...
public class SkipListMap<K extends Comparable<K>, V> implements SkipList.INodeCreator<K>, IMap<K,V> {
     ...
     */
    @Override
    public Node<K> createNewNode(int level, K key) {
    ...
    protected static class SkipListMapNode<K extends Comparable<K>, V> extends Node<K> {
