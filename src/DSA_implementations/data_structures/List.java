...
import DSA_implementations.data_structures.interfaces.IList;
 ...
 * elements, or terms). The number of elements (possibly infinite) is called the
 * length of the sequence. Unlike a set, order matters, and exactly the same
 * elements can appear multiple times at different positions in the sequence.
 * <p>
 * @see <a href="https://en.wikipedia.org/wiki/Sequence">Sequence
 * (Wikipedia)</a>
 * <br>
...
public abstract class List<T> implements IList<T> {
     ...
     * <p>
     * @see <a href="https://en.wikipedia.org/wiki/Dynamic_array">Dynamic Array
     * (Wikipedia)</a>
     * <br>
     * @author Justin Wetherell <phishman3579@gmail.com>
     */
