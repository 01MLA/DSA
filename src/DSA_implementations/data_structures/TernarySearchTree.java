...
import DSA_implementations.data_structures.interfaces.ITree;
    ...
    public static class JavaCompatibleTree<C extends CharSequence> extends java.util.AbstractCollection<C> {
        ...
        private static class TreeIterator<C extends CharSequence> implements java.util.Iterator<C> {
            ...
            protected TreeIterator(TernarySearchTree<C> tree) {
                this.tree = tree;
                java.util.Map<Node,String> map = new java.util.LinkedHashMap<Node,String>();
            ...
            private void getNodesWhichRepresentsWords(Node node, String string, java.util.Map<Node,String> nodesMap) {
            ...
            public C next() {
                ...
                java.util.Map.Entry<Node,String> entry = iterator.next();
