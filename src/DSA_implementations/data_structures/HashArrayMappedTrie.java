...
public class HashArrayMappedTrie<K, V> implements IMap<K,V> {
    ...
    private static class JavaCompatibleIteratorWrapper<K,V> implements java.util.Iterator<Map.Entry<K, V>> {

        private HashArrayMappedTrie<K,V> map = null;
        private java.util.Iterator<Map.Entry<K, V>> iter = null;
        private Map.Entry<K, V> lastEntry = null;

        public JavaCompatibleIteratorWrapper(HashArrayMappedTrie<K,V> map, java.util.Iterator<Map.Entry<K, V>> iter) {
            this.map = map;
            this.iter = iter;
        }
    ...
    private static class JavaCompatibleMap<K, V> extends java.util.AbstractMap<K,V> {
        ...
        private void addToSet(java.util.Set<Entry<K, V>> set, Node node) {
            if (node instanceof KeyValueNode) {
                KeyValueNode<V> kvNode = (KeyValueNode<V>) node;
