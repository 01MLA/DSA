...
import DSA_implementations.data_structures.Graph;
import DSA_implementations.data_structures.Graph.Edge;
import DSA_implementations.data_structures.Graph.Vertex;
...
public class DepthFirstTraversal {
    ...
    public static <T extends Comparable<T>> Vertex<T>[] depthFirstTraversal(Graph<T> graph, Vertex<T> source) {
